...
class School(models.Model):
    title = models.CharField(verbose_name='学校', max_length=32)
...
class Course(models.Model):
    title = models.CharField(verbose_name='课程', max_length=32)
...
class Development(models.Model):
    title = models.CharField(verbose_name='方向', max_length=32)
...
class Classes(models.Model):
    school = models.ForeignKey(verbose_name='学校', to='School')
    course = models.ForeignKey(verbose_name='课程', to='Course')
    develop = models.ForeignKey(verbose_name='方向', to='Development')
    teacher = models.ManyToManyField(verbose_name='老师', to='UserInfo', related_name='classes',
    ...
    def __str__(self):
        return f'{self.course}*{self.develop}'
...
class Customer(models.Model):
    ...
    course = models.ManyToManyField(verbose_name="咨询课程", to="Classes")
...
class PaymentRecord(models.Model):
    ...
    classes = models.ForeignKey(verbose_name="申请班级", to="Classes")
...
class Student(models.Model):
    ...
    学生表
    """
    user = models.OneToOneField(verbose_name='用户', to='UserInfo', null=True, blank=True)
...
class Homework(models.Model):
    ...
    班级作业
    """
    classes = models.ForeignKey(verbose_name='班级', to='Classes')
    title = models.CharField(verbose_name='作业名称', max_length=128)
    publish_date = models.DateTimeField(verbose_name="发布日期", auto_now_add=True)
...
class HomeworkScore(models.Model):
    homework = models.ForeignKey(verbose_name='作业', to='Homework' )
    classes = models.ForeignKey(verbose_name='课程', to='Classes')
    student = models.ForeignKey(verbose_name='学生', to='Student')
...
class CourseRecord(models.Model):
    ...
    def __str__(self):
        return "{0} day{1}".format(self.classes, self.day_num)
